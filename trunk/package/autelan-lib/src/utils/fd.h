...
#ifndef INLINE_FD
#define INLINE_FD       __FD
#endif

#define USE_INLINE_FD   fd_control_t INLINE_FD
extern USE_INLINE_FD;

static inline fd_control_t *
__fd(void)
{
#ifdef __USE_INLINE_FD
    return &INLINE_FD;
#else
    return NULL;
#endif
