...
define KernelPackage/iio-adc081c
  SUBMENU:=$(OTHER_MENU)
  DEPENDS:=kmod-i2c-core kmod-iio-core
  TITLE:=TI-ADC081c I2C
  KCONFIG:=CONFIG_TI_ADC081C=y
  FILES:=$(LINUX_DIR)/drivers/iio/adc/ti-adc081c.ko
  AUTOLOAD:=$(call AutoLoad,56,ti-adc081c)
endef

define KernelPackage/iio-adc081c/description
 Kernel module for ti-adc081c
endef

$(eval $(call KernelPackage,iio-adc081c))
